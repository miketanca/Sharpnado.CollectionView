...
namespace Sharpnado.CollectionView.Droid.Renderers
{
    public partial class CollectionViewRenderer
    {
        private class DragAnDropItemTouchHelperCallback : ItemTouchHelper.Callback
        {
            ...
            public DragAnDropItemTouchHelperCallback(CollectionView collection, RecycleViewAdapter recycleViewAdapter, ICommand onDragAndDropStart = null, ICommand onDragAndDropdEnded = null)
            {
